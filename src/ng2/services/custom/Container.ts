...
export class ContainerApi extends BaseLoopBackApi {
   ...
   *  - `` – `{}` - 
   */
  public export(applicationId: any, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/containers/export";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof applicationId !== 'undefined' && applicationId !== null) _urlParams.applicationId = applicationId;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   * </em>
   */
  public exportReport(options: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/containers/exportReport";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
