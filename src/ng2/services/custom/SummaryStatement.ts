...
/**
 * Api services for the `SummaryStatement` model.
 */
@Injectable()
export class SummaryStatementApi extends BaseLoopBackApi {
  ...
  public getCreatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/SummaryStatements/:id/createdBy";
  ...
  public getLastUpdatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SummaryStatements/:id/lastUpdatedBy";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getCreater(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SummaryStatements/:id/creater";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
