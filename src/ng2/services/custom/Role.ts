...
export class RoleApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public updateByIdPrincipals(id: any, fk: any, data: RoleMapping = new RoleMapping(), customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public createPrincipals(id: any, data: RoleMapping = new RoleMapping(), customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public createManyPrincipals(id: any, data: RoleMapping[] = new Array<RoleMapping>(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Roles/:id/principals";
    let _routeParams: any = {
