...
/**
 * Api services for the `DispatchEmployee` model.
 */
@Injectable()
export class DispatchEmployeeApi extends BaseLoopBackApi {
  ...
  public getCreatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/DispatchEmployees/:id/createdBy";
  ...
  public getLastUpdatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DispatchEmployees/:id/lastUpdatedBy";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getDispatch(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DispatchEmployees/:id/dispatch";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
