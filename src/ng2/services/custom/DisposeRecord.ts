...
/**
 * Api services for the `DisposeRecord` model.
 */
@Injectable()
export class DisposeRecordApi extends BaseLoopBackApi {
  ...
  public getLastUpdatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DisposeRecords/:id/lastUpdatedBy";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getReport(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DisposeRecords/:id/report";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getDisposeEmployee(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/DisposeRecords/:id/disposeEmployee";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
