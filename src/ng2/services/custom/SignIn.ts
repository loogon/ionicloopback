...
/**
 * Api services for the `SignIn` model.
 */
@Injectable()
export class SignInApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getLocationReport(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SignIns/:id/locationReport";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createLocationReport(id: any, data: LocationReport = new LocationReport(), customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public updateLocationReport(id: any, data: LocationReport = new LocationReport(), customHeaders?: Function): Observable<any> {
   ...
   */
  public destroyLocationReport(id: any, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public createManyLocationReport(id: any, data: LocationReport[] = new Array<LocationReport>(), customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SignIns/:id/locationReport";
    let _routeParams: any = {
