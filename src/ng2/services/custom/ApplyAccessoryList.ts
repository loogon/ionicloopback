...
/**
 * Api services for the `ApplyAccessoryList` model.
 */
@Injectable()
export class ApplyAccessoryListApi extends BaseLoopBackApi {
  ...
  public getCreatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    ...
    "/ApplyAccessoryLists/:id/createdBy";
  ...
  public getLastUpdatedBy(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ApplyAccessoryLists/:id/lastUpdatedBy";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getApplication(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ApplyAccessoryLists/:id/application";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getOldAccessoryInfo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ApplyAccessoryLists/:id/oldAccessoryInfo";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public getNewAccessoryInfo(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ApplyAccessoryLists/:id/newAccessoryInfo";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
